...
## Description
A lightweight inventory management system API built with Laravel 11 and PHP 8.4. It is designed to be an API-first application for managing products, stock levels, suppliers, and storage locations.
